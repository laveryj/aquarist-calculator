...
loadPartial('import-coming_soon', '/aquarist-calculator/partials/coming_soon.html');
    ...
    // Global declaration of calculator pages
    const tankVolumeSquarePage = document.getElementById("volume-square");
    const tankVolumeCylinderPage = document.getElementById("volume-cylinder");

    // Global declaration of calculator category buttons
    const tankVolumeSquareBtn = document.getElementById("volume-square-calculate-btn");
    const tankVolumeCylinderBtn = document.getElementById("volume-cylinder-calculate-btn");
    ...
    if (tankVolumeSquarePage) {
        tankVolumeSquarePage.addEventListener("click", function(event) { // Add event parameter to the function
            event.preventDefault();
            console.log("Tank Volume Square button clicked");
    ...
    if (tankVolumeCylinderPage) {
        tankVolumeCylinderPage.addEventListener("click", function(event) { // Add event parameter to the function
            event.preventDefault();
            console.log("Tank Volume Cylinder button clicked");
    ...
    // Check if volume tank square calculate pressed
    if (tankVolumeSquareBtn) {
        tankVolumeSquareBtn.addEventListener("click", function(event) { // Add event parameter to the function
            calculateTankVolumeSquare();
        });
    }

    // Check if volume tank cylinderical calculate pressed
    if (tankVolumeCylinderBtn) {
        tankVolumeCylinderBtn.addEventListener("click", function(event) { // Add event parameter to the function
            calculateTankVolumeCylinder();
        });
    }
